...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:xn,depthTest:!1,depthWrite:!1})}function Cp(n,e,t){const i=new Float32Array(Zn),r=new k(0,1,0);return new Xt({name:"SphericalGaussianBlur",defines:{n:Zn,CUBEUV_TEXEL_WIDTH:1/e,CUBEUV_TEXEL_HEIGHT:1/t,CUBEUV_MAX_MIP:`${n}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:i},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:r}},vertexShader:os(),fragmentShader:`
	...
	`}class Ic extends en{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;const i={width:e,height:e,depth:1},r=[i,i,i,i,i,i];this.texture=new Rc(r),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;const i={uniforms:{tEquirect:{value:null}},vertexShader:`
			...
			`},r=new ar(5,5,5),s=new Xt({name:"CubemapFromEquirect",uniforms:Ci(i.uniforms),vertexShader:i.vertexShader,fragmentShader:i.fragmentShader,side:Rt,blending:xn});s.uniforms.tEquirect.value=t;const a=new an(r,s),o=t.minFilter;return t.minFilter===Jn&&(t.minFilter=yt),new Ff(1,10,this).update(e,a),t.minFilter=o,a.geometry.dispose(),a.material.dispose(),this}clear(e,t=!0,i=!0,r=!0){const s=e.getRenderTarget();for(let a=0;a<6;a++)e.setRenderTarget(this,a),e.clear(t,i,r);e.setRenderTarget(s)}}function Pp(n){let e=new WeakMap,t=new WeakMap,i=null;function r(f,d=!1){return f==null?null:d?a(f):s(f)}function s(f){if(f&&f.isTexture){const d=f.mapping;if(d===ms||d===gs)if(e.has(f)){const g=e.get(f).texture;return o(g,f.mapping)}else{const g=f.image;if(g&&g.height>0){const y=new Ic(g.height);return y.fromEquirectangularTexture(n,f),e.set(f,y),f.addEventListener("dispose",l),o(y.texture,f.mapping)}else return null}}return f}function a(f){if(f&&f.isTexture){const d=f.mapping,g=d===ms||d===gs,y=d===ti||d===wi;if(g||y){let p=t.get(f);const m=p!==void 0?p.texture.pmremVersion:0;if(f.isRenderTargetTexture&&f.pmremVersion!==m)return i===null&&(i=new al(n)),p=g?i.fromEquirectangular(f,p):i.fromCubemap(f,p),p.texture.pmremVersion=f.pmremVersion,t.set(f,p),p.texture;if(p!==void 0)return p.texture;{const S=f.image;return g&&S&&S.height>0||y&&S&&c(S)?(i===null&&(i=new al(n)),p=g?i.fromEquirectangular(f):i.fromCubemap(f),p.texture.pmremVersion=f.pmremVersion,t.set(f,p),f.addEventListener("dispose",u),p.texture):null}}}return f}function o(f,d){return d===ms?f.mapping=ti:d===gs&&(f.mapping=wi),f}function c(f){let d=0;const g=6;for(let y=0;y<g;y++)f[y]!==void 0&&d++;return d===g}function l(f){const d=f.target;d.removeEventListener("dispose",l);const g=e.get(d);g!==void 0&&(e.delete(d),g.dispose())}function u(f){const d=f.target;d.removeEventListener("dispose",u);const g=t.get(d);g!==void 0&&(t.delete(d),g.dispose())}function h(){e=new WeakMap,t=new WeakMap,i!==null&&(i.dispose(),i=null)}return{get:r,dispose:h}}function Lp(n){const e={};function t(i){if(e[i]!==void 0)return e[i];const r=n.getExtension(i);return e[i]=r,r}return{has:function(i){return t(i)!==null},init:function(){t("EXT_color_buffer_float"),t("WEBGL_clip_cull_distance"),t("OES_texture_float_linear"),t("EXT_color_buffer_half_float"),t("WEBGL_multisampled_render_to_texture"),t("WEBGL_render_shared_exponent")},get:function(i){const r=t(i);return r===null&&jr("WebGLRenderer: "+i+" extension not supported."),r}}}function Dp(n,e,t,i){const r={},s=new WeakMap;function a(h){const f=h.target;f.index!==null&&e.remove(f.index);for(const g in f.attributes)e.remove(f.attributes[g]);f.removeEventListener("dispose",a),delete r[f.id];const d=s.get(f);d&&(e.remove(d),s.delete(f)),i.releaseStatesOfGeometry(f),f.isInstancedBufferGeometry===!0&&delete f._maxInstanceCount,t.memory.geometries--}function o(h,f){return r[f.id]===!0||(f.addEventListener("dispose",a),r[f.id]=!0,t.memory.geometries++),f}function c(h){const f=h.attributes;for(const d in f)e.update(f[d],n.ARRAY_BUFFER)}function l(h){const f=[],d=h.index,g=h.attributes.position;let y=0;if(g===void 0)return;if(d!==null){const S=d.array;y=d.version;for(let T=0,x=S.length;T<x;T+=3){const R=S[T+0],M=S[T+1],A=S[T+2];f.push(R,M,M,A,A,R)}}else{const S=g.array;y=g.version;for(let T=0,x=S.length/3-1;T<x;T+=3){const R=T+0,M=T+1,A=T+2;f.push(R,M,M,A,A,R)}}const p=new(g.count>=65535?Tc:Ec)(f,1);p.version=y;const m=s.get(h);m&&e.remove(m),s.set(h,p)}function u(h){const f=s.get(h);if(f){const d=h.index;d!==null&&f.version<d.version&&l(h)}else l(h);return s.get(h)}return{get:o,update:c,getWireframeAttribute:u}}function Ip(n,e,t){let i;function r(f){i=f}let s,a;function o(f){s=f.type,a=f.bytesPerElement}function c(f,d){n.drawElements(i,d,s,f*a),t.update(d,i,1)}function l(f,d,g){g!==0&&(n.drawElementsInstanced(i,d,s,f*a,g),t.update(d,i,g))}function u(f,d,g){if(g===0)return;e.get("WEBGL_multi_draw").multiDrawElementsWEBGL(i,d,0,s,f,0,g);let p=0;for(let m=0;m<g;m++)p+=d[m];t.update(p,i,1)}function h(f,d,g,y){if(g===0)return;const p=e.get("WEBGL_multi_draw");if(p===null)for(let m=0;m<f.length;m++)l(f[m]/a,d[m],y[m]);else{p.multiDrawElementsInstancedWEBGL(i,d,0,s,f,0,y,0,g);let m=0;for(let S=0;S<g;S++)m+=d[S]*y[S];t.update(m,i,1)}}this.setMode=r,this.setIndex=o,this.render=c,this.renderInstances=l,this.renderMultiDraw=u,this.renderMultiDrawInstances=h}function Np(n){const e={geometries:0,textures:0},t={frame:0,calls:0,triangles:0,points:0,lines:0};function i(s,a,o){switch(t.calls++,a){case n.TRIANGLES:t.triangles+=o*(s/3);break;case n.LINES:t.lines+=o*(s/2);break;case n.LINE_STRIP:t.lines+=o*(s-1);break;case n.LINE_LOOP:t.lines+=o*s;break;case n.POINTS:t.points+=o*s;break;default:He("WebGLInfo: Unknown draw mode:",a);break}}function r(){t.calls=0,t.triangles=0,t.points=0,t.lines=0}return{memory:e,render:t,programs:null,autoReset:!0,reset:r,update:i}}function Up(n,e,t){const i=new WeakMap,r=new at;function s(a,o,c){const l=a.morphTargetInfluences,u=o.morphAttributes.position||o.morphAttributes.normal||o.morphAttributes.color,h=u!==void 0?u.length:0;let f=i.get(o);if(f===void 0||f.count!==h){let G=function(){v.dispose(),i.delete(o),o.removeEventListener("dispose",G)};var d=G;f!==void 0&&f.texture.dispose();const g=o.morphAttributes.position!==void 0,y=o.morphAttributes.normal!==void 0,p=o.morphAttributes.color!==void 0,m=o.morphAttributes.position||[],S=o.morphAttributes.normal||[],T=o.morphAttributes.color||[];let x=0;g===!0&&(x=1),y===!0&&(x=2),p===!0&&(x=3);let R=o.attributes.position.count*x,M=1;R>e.maxTextureSize&&(M=Math.ceil(R/e.maxTextureSize),R=e.maxTextureSize);const A=new Float32Array(R*M*4*h),v=new Mc(A,R,M,h);v.type=Jt,v.needsUpdate=!0;const E=x*4;for(let C=0;C<h;C++){const O=m[C],F=S[C],W=T[C],z=R*M*4*C;for(let V=0;V<O.count;V++){const N=V*E;g===!0&&(r.fromBufferAttribute(O,V),A[z+N+0]=r.x,A[z+N+1]=r.y,A[z+N+2]=r.z,A[z+N+3]=0),y===!0&&(r.fromBufferAttribute(F,V),A[z+N+4]=r.x,A[z+N+5]=r.y,A[z+N+6]=r.z,A[z+N+7]=0),p===!0&&(r.fromBufferAttribute(W,V),A[z+N+8]=r.x,A[z+N+9]=r.y,A[z+N+10]=r.z,A[z+N+11]=W.itemSize===4?r.w:1)}}f={count:h,texture:v,size:new Ge(R,M)},i.set(o,f),o.addEventListener("dispose",G)}if(a.isInstancedMesh===!0&&a.morphTexture!==null)c.getUniforms().setValue(n,"morphTexture",a.morphTexture,t);else{let g=0;for(let p=0;p<l.length;p++)g+=l[p];const y=o.morphTargetsRelative?1:1-g;c.getUniforms().setValue(n,"morphTargetBaseInfluence",y),c.getUniforms().setValue(n,"morphTargetInfluences",l)}c.getUniforms().setValue(n,"morphTargetsTexture",f.texture,t),c.getUniforms().setValue(n,"morphTargetsTextureSize",f.size)}return{update:s}}function Fp(n,e,t,i,r){let s=new WeakMap;function a(l){const u=r.render.frame,h=l.geometry,f=e.get(l,h);if(s.get(f)!==u&&(e.update(f),s.set(f,u)),l.isInstancedMesh&&(l.hasEventListener("dispose",c)===!1&&l.addEventListener("dispose",c),s.get(l)!==u&&(t.update(l.instanceMatrix,n.ARRAY_BUFFER),l.instanceColor!==null&&t.update(l.instanceColor,n.ARRAY_BUFFER),s.set(l,u))),l.isSkinnedMesh){const d=l.skeleton;s.get(d)!==u&&(d.update(),s.set(d,u))}return f}function o(){s=new WeakMap}function c(l){const u=l.target;u.removeEventListener("dispose",c),i.releaseStatesOfObject(u),t.remove(u.instanceMatrix),u.instanceColor!==null&&t.remove(u.instanceColor)}return{update:a,dispose:o}}const Op={[sc]:"LINEAR_TONE_MAPPING",[ac]:"REINHARD_TONE_MAPPING",[oc]:"CINEON_TONE_MAPPING",[lc]:"ACES_FILMIC_TONE_MAPPING",[uc]:"AGX_TONE_MAPPING",[fc]:"NEUTRAL_TONE_MAPPING",[cc]:"CUSTOM_TONE_MAPPING"};function Bp(n,e,t,i,r){const s=new en(e,t,{type:n,depthBuffer:i,stencilBuffer:r}),a=new en(e,t,{type:Mn,depthBuffer:!1,stencilBuffer:!1}),o=new Tn;o.setAttribute("position",new yn([-1,3,0,-1,-1,0,3,-1,0],3)),o.setAttribute("uv",new yn([0,2,0,0,2,0],2));const c=new If({uniforms:{tDiffuse:{value:null}},vertexShader:`
			precision highp float;
...
`)}const Nm={[sc]:"Linear",[ac]:"Reinhard",[oc]:"Cineon",[lc]:"ACESFilmic",[uc]:"AgX",[fc]:"Neutral",[cc]:"Custom"};function Um(n,e){const t=Nm[e];return t===void 0?(Ce("WebGLProgram: Unsupported toneMapping:",e),"vec3 "+n+"( vec3 color ) { return LinearToneMapping( color ); }"):"vec3 "+n+"( vec3 color ) { return "+t+"ToneMapping( color ); }"}const Nr=new k;function Fm(){ke.getLuminanceCoefficients(Nr);const n=Nr.x.toFixed(4),e=Nr.y.toFixed(4),t=Nr.z.toFixed(4);return["float luminance( const in vec3 rgb ) {",`	const vec3 weights = vec3( ${n}, ${e}, ${t} );`,"	return dot( weights, rgb );","}"].join(`
...
`)+`
`+m);const T=S+p+a,x=S+m+o,R=gl(r,r.VERTEX_SHADER,T),M=gl(r,r.FRAGMENT_SHADER,x);r.attachShader(y,R),r.attachShader(y,M),t.index0AttributeName!==void 0?r.bindAttribLocation(y,0,t.index0AttributeName):t.morphTargets===!0&&r.bindAttribLocation(y,0,"position"),r.linkProgram(y);function A(C){if(n.debug.checkShaderErrors){const O=r.getProgramInfoLog(y)||"",F=r.getShaderInfoLog(R)||"",W=r.getShaderInfoLog(M)||"",z=O.trim(),V=F.trim(),N=W.trim();let Q=!0,Z=!0;if(r.getProgramParameter(y,r.LINK_STATUS)===!1)if(Q=!1,typeof n.debug.onShaderError=="function")n.debug.onShaderError(r,y,R,M);else{const ce=xl(r,R,"vertex"),pe=xl(r,M,"fragment");He("THREE.WebGLProgram: Shader Error "+r.getError()+" - VALIDATE_STATUS "+r.getProgramParameter(y,r.VALIDATE_STATUS)+`
...
Program Info Log: `+z+`
`+ce+`
`+pe)}else z!==""?Ce("WebGLProgram: Program Info Log:",z):(V===""||N==="")&&(Z=!1);Z&&(C.diagnostics={runnable:Q,programLog:z,vertexShader:{log:V,prefix:p},fragmentShader:{log:N,prefix:m}})}r.deleteShader(R),r.deleteShader(M),v=new Xr(r,y),E=zm(r,y)}let v;this.getUniforms=function(){return v===void 0&&A(this),v};let E;this.getAttributes=function(){return E===void 0&&A(this),E};let G=t.rendererExtensionParallelShaderCompile===!1;return this.isReady=function(){return G===!1&&(G=r.getProgramParameter(y,Cm)),G},this.destroy=function(){i.releaseStatesOfProgram(this),r.deleteProgram(y),this.program=void 0},this.type=t.shaderType,this.name=t.shaderName,this.id=Pm++,this.cacheKey=e,this.usedTimes=1,this.program=y,this.vertexShader=R,this.fragmentShader=M,this}let tg=0;class ng{constructor(){this.shaderCache=new Map,this.materialCache=new Map}update(e){const t=e.vertexShader,i=e.fragmentShader,r=this._getShaderStage(t),s=this._getShaderStage(i),a=this._getShaderCacheForMaterial(e);return a.has(r)===!1&&(a.add(r),r.usedTimes++),a.has(s)===!1&&(a.add(s),s.usedTimes++),this}remove(e){const t=this.materialCache.get(e);for(const i of t)i.usedTimes--,i.usedTimes===0&&this.shaderCache.delete(i.code);return this.materialCache.delete(e),this}getVertexShaderID(e){return this._getShaderStage(e.vertexShader).id}getFragmentShaderID(e){return this._getShaderStage(e.fragmentShader).id}dispose(){this.shaderCache.clear(),this.materialCache.clear()}_getShaderCacheForMaterial(e){const t=this.materialCache;let i=t.get(e);return i===void 0&&(i=new Set,t.set(e,i)),i}_getShaderStage(e){const t=this.shaderCache;let i=t.get(e);return i===void 0&&(i=new ig(e),t.set(e,i)),i}}class ig{constructor(e){this.id=tg++,this.code=e,this.usedTimes=0}}function rg(n,e,t,i,r,s){const a=new Sc,o=new ng,c=new Set,l=[],u=new Map,h=i.logarithmicDepthBuffer;let f=i.precision;const d={MeshDepthMaterial:"depth",MeshDistanceMaterial:"distance",MeshNormalMaterial:"normal",MeshBasicMaterial:"basic",MeshLambertMaterial:"lambert",MeshPhongMaterial:"phong",MeshToonMaterial:"toon",MeshStandardMaterial:"physical",MeshPhysicalMaterial:"physical",MeshMatcapMaterial:"matcap",LineBasicMaterial:"basic",LineDashedMaterial:"dashed",PointsMaterial:"points",ShadowMaterial:"shadow",SpriteMaterial:"sprite"};function g(v){return c.add(v),v===0?"uv":`uv${v}`}function y(v,E,G,C,O){const F=C.fog,W=O.geometry,z=v.isMeshStandardMaterial||v.isMeshLambertMaterial||v.isMeshPhongMaterial?C.environment:null,V=v.isMeshStandardMaterial||v.isMeshLambertMaterial&&!v.envMap||v.isMeshPhongMaterial&&!v.envMap,N=e.get(v.envMap||z,V),Q=N&&N.mapping===ss?N.image.height:null,Z=d[v.type];v.precision!==null&&(f=i.getMaxPrecision(v.precision),f!==v.precision&&Ce("WebGLProgram.getParameters:",v.precision,"not supported, using",f,"instead."));const ce=W.morphAttributes.position||W.morphAttributes.normal||W.morphAttributes.color,pe=ce!==void 0?ce.length:0;let fe=0;W.morphAttributes.position!==void 0&&(fe=1),W.morphAttributes.normal!==void 0&&(fe=2),W.morphAttributes.color!==void 0&&(fe=3);let Ie,nt,tt,Y;if(Z){const $e=Zt[Z];Ie=$e.vertexShader,nt=$e.fragmentShader}else Ie=v.vertexShader,nt=v.fragmentShader,o.update(v),tt=o.getVertexShaderID(v),Y=o.getFragmentShaderID(v);const ne=n.getRenderTarget(),se=n.state.buffers.depth.getReversed(),Le=O.isInstancedMesh===!0,Te=O.isBatchedMesh===!0,Ae=!!v.map,dt=!!v.matcap,ze=!!N,Xe=!!v.aoMap,Je=!!v.lightMap,Ue=!!v.bumpMap,rt=!!v.normalMap,P=!!v.displacementMap,ot=!!v.emissiveMap,We=!!v.metalnessMap,Qe=!!v.roughnessMap,ye=v.anisotropy>0,w=v.clearcoat>0,_=v.dispersion>0,D=v.iridescence>0,q=v.sheen>0,K=v.transmission>0,$=ye&&!!v.anisotropyMap,me=w&&!!v.clearcoatMap,ie=w&&!!v.clearcoatNormalMap,Ee=w&&!!v.clearcoatRoughnessMap,we=D&&!!v.iridescenceMap,J=D&&!!v.iridescenceThicknessMap,ee=q&&!!v.sheenColorMap,ge=q&&!!v.sheenRoughnessMap,xe=!!v.specularMap,ue=!!v.specularColorMap,Fe=!!v.specularIntensityMap,L=K&&!!v.transmissionMap,re=K&&!!v.thicknessMap,te=!!v.gradientMap,he=!!v.alphaMap,j=v.alphaTest>0,X=!!v.alphaHash,_e=!!v.extensions;let Re=Qt;v.toneMapped&&(ne===null||ne.isXRRenderTarget===!0)&&(Re=n.toneMapping);const et={shaderID:Z,shaderType:v.type,shaderName:v.name,vertexShader:Ie,fragmentShader:nt,defines:v.defines,customVertexShaderID:tt,customFragmentShaderID:Y,isRawShaderMaterial:v.isRawShaderMaterial===!0,glslVersion:v.glslVersion,precision:f,batching:Te,batchingColor:Te&&O._colorsTexture!==null,instancing:Le,instancingColor:Le&&O.instanceColor!==null,instancingMorph:Le&&O.morphTexture!==null,outputColorSpace:ne===null?n.outputColorSpace:ne.isXRRenderTarget===!0?ne.texture.colorSpace:Ri,alphaToCoverage:!!v.alphaToCoverage,map:Ae,matcap:dt,envMap:ze,envMapMode:ze&&N.mapping,envMapCubeUVHeight:Q,aoMap:Xe,lightMap:Je,bumpMap:Ue,normalMap:rt,displacementMap:P,emissiveMap:ot,normalMapObjectSpace:rt&&v.normalMapType===Xu,normalMapTangentSpace:rt&&v.normalMapType===Wu,metalnessMap:We,roughnessMap:Qe,anisotropy:ye,anisotropyMap:$,clearcoat:w,clearcoatMap:me,clearcoatNormalMap:ie,clearcoatRoughnessMap:Ee,dispersion:_,iridescence:D,iridescenceMap:we,iridescenceThicknessMap:J,sheen:q,sheenColorMap:ee,sheenRoughnessMap:ge,specularMap:xe,specularColorMap:ue,specularIntensityMap:Fe,transmission:K,transmissionMap:L,thicknessMap:re,gradientMap:te,opaque:v.transparent===!1&&v.blending===Mi&&v.alphaToCoverage===!1,alphaMap:he,alphaTest:j,alphaHash:X,combine:v.combine,mapUv:Ae&&g(v.map.channel),aoMapUv:Xe&&g(v.aoMap.channel),lightMapUv:Je&&g(v.lightMap.channel),bumpMapUv:Ue&&g(v.bumpMap.channel),normalMapUv:rt&&g(v.normalMap.channel),displacementMapUv:P&&g(v.displacementMap.channel),emissiveMapUv:ot&&g(v.emissiveMap.channel),metalnessMapUv:We&&g(v.metalnessMap.channel),roughnessMapUv:Qe&&g(v.roughnessMap.channel),anisotropyMapUv:$&&g(v.anisotropyMap.channel),clearcoatMapUv:me&&g(v.clearcoatMap.channel),clearcoatNormalMapUv:ie&&g(v.clearcoatNormalMap.channel),clearcoatRoughnessMapUv:Ee&&g(v.clearcoatRoughnessMap.channel),iridescenceMapUv:we&&g(v.iridescenceMap.channel),iridescenceThicknessMapUv:J&&g(v.iridescenceThicknessMap.channel),sheenColorMapUv:ee&&g(v.sheenColorMap.channel),sheenRoughnessMapUv:ge&&g(v.sheenRoughnessMap.channel),specularMapUv:xe&&g(v.specularMap.channel),specularColorMapUv:ue&&g(v.specularColorMap.channel),specularIntensityMapUv:Fe&&g(v.specularIntensityMap.channel),transmissionMapUv:L&&g(v.transmissionMap.channel),thicknessMapUv:re&&g(v.thicknessMap.channel),alphaMapUv:he&&g(v.alphaMap.channel),vertexTangents:!!W.attributes.tangent&&(rt||ye),vertexColors:v.vertexColors,vertexAlphas:v.vertexColors===!0&&!!W.attributes.color&&W.attributes.color.itemSize===4,pointsUvs:O.isPoints===!0&&!!W.attributes.uv&&(Ae||he),fog:!!F,useFog:v.fog===!0,fogExp2:!!F&&F.isFogExp2,flatShading:v.wireframe===!1&&(v.flatShading===!0||W.attributes.normal===void 0&&rt===!1&&(v.isMeshLambertMaterial||v.isMeshPhongMaterial||v.isMeshStandardMaterial||v.isMeshPhysicalMaterial)),sizeAttenuation:v.sizeAttenuation===!0,logarithmicDepthBuffer:h,reversedDepthBuffer:se,skinning:O.isSkinnedMesh===!0,morphTargets:W.morphAttributes.position!==void 0,morphNormals:W.morphAttributes.normal!==void 0,morphColors:W.morphAttributes.color!==void 0,morphTargetsCount:pe,morphTextureStride:fe,numDirLights:E.directional.length,numPointLights:E.point.length,numSpotLights:E.spot.length,numSpotLightMaps:E.spotLightMap.length,numRectAreaLights:E.rectArea.length,numHemiLights:E.hemi.length,numDirLightShadows:E.directionalShadowMap.length,numPointLightShadows:E.pointShadowMap.length,numSpotLightShadows:E.spotShadowMap.length,numSpotLightShadowsWithMaps:E.numSpotLightShadowsWithMaps,numLightProbes:E.numLightProbes,numClippingPlanes:s.numPlanes,numClipIntersection:s.numIntersection,dithering:v.dithering,shadowMapEnabled:n.shadowMap.enabled&&G.length>0,shadowMapType:n.shadowMap.type,toneMapping:Re,decodeVideoTexture:Ae&&v.map.isVideoTexture===!0&&ke.getTransfer(v.map.colorSpace)===qe,decodeVideoTextureEmissive:ot&&v.emissiveMap.isVideoTexture===!0&&ke.getTransfer(v.emissiveMap.colorSpace)===qe,premultipliedAlpha:v.premultipliedAlpha,doubleSided:v.side===gn,flipSided:v.side===Rt,useDepthPacking:v.depthPacking>=0,depthPacking:v.depthPacking||0,index0AttributeName:v.index0AttributeName,extensionClipCullDistance:_e&&v.extensions.clipCullDistance===!0&&t.has("WEBGL_clip_cull_distance"),extensionMultiDraw:(_e&&v.extensions.multiDraw===!0||Te)&&t.has("WEBGL_multi_draw"),rendererExtensionParallelShaderCompile:t.has("KHR_parallel_shader_compile"),customProgramCacheKey:v.customProgramCacheKey()};return et.vertexUv1s=c.has(1),et.vertexUv2s=c.has(2),et.vertexUv3s=c.has(3),c.clear(),et}function p(v){const E=[];if(v.shaderID?E.push(v.shaderID):(E.push(v.customVertexShaderID),E.push(v.customFragmentShaderID)),v.defines!==void 0)for(const G in v.defines)E.push(G),E.push(v.defines[G]);return v.isRawShaderMaterial===!1&&(m(E,v),S(E,v),E.push(n.outputColorSpace)),E.push(v.customProgramCacheKey),E.join()}function m(v,E){v.push(E.precision),v.push(E.outputColorSpace),v.push(E.envMapMode),v.push(E.envMapCubeUVHeight),v.push(E.mapUv),v.push(E.alphaMapUv),v.push(E.lightMapUv),v.push(E.aoMapUv),v.push(E.bumpMapUv),v.push(E.normalMapUv),v.push(E.displacementMapUv),v.push(E.emissiveMapUv),v.push(E.metalnessMapUv),v.push(E.roughnessMapUv),v.push(E.anisotropyMapUv),v.push(E.clearcoatMapUv),v.push(E.clearcoatNormalMapUv),v.push(E.clearcoatRoughnessMapUv),v.push(E.iridescenceMapUv),v.push(E.iridescenceThicknessMapUv),v.push(E.sheenColorMapUv),v.push(E.sheenRoughnessMapUv),v.push(E.specularMapUv),v.push(E.specularColorMapUv),v.push(E.specularIntensityMapUv),v.push(E.transmissionMapUv),v.push(E.thicknessMapUv),v.push(E.combine),v.push(E.fogExp2),v.push(E.sizeAttenuation),v.push(E.morphTargetsCount),v.push(E.morphAttributeCount),v.push(E.numDirLights),v.push(E.numPointLights),v.push(E.numSpotLights),v.push(E.numSpotLightMaps),v.push(E.numHemiLights),v.push(E.numRectAreaLights),v.push(E.numDirLightShadows),v.push(E.numPointLightShadows),v.push(E.numSpotLightShadows),v.push(E.numSpotLightShadowsWithMaps),v.push(E.numLightProbes),v.push(E.shadowMapType),v.push(E.toneMapping),v.push(E.numClippingPlanes),v.push(E.numClipIntersection),v.push(E.depthPacking)}function S(v,E){a.disableAll(),E.instancing&&a.enable(0),E.instancingColor&&a.enable(1),E.instancingMorph&&a.enable(2),E.matcap&&a.enable(3),E.envMap&&a.enable(4),E.normalMapObjectSpace&&a.enable(5),E.normalMapTangentSpace&&a.enable(6),E.clearcoat&&a.enable(7),E.iridescence&&a.enable(8),E.alphaTest&&a.enable(9),E.vertexColors&&a.enable(10),E.vertexAlphas&&a.enable(11),E.vertexUv1s&&a.enable(12),E.vertexUv2s&&a.enable(13),E.vertexUv3s&&a.enable(14),E.vertexTangents&&a.enable(15),E.anisotropy&&a.enable(16),E.alphaHash&&a.enable(17),E.batching&&a.enable(18),E.dispersion&&a.enable(19),E.batchingColor&&a.enable(20),E.gradientMap&&a.enable(21),v.push(a.mask),a.disableAll(),E.fog&&a.enable(0),E.useFog&&a.enable(1),E.flatShading&&a.enable(2),E.logarithmicDepthBuffer&&a.enable(3),E.reversedDepthBuffer&&a.enable(4),E.skinning&&a.enable(5),E.morphTargets&&a.enable(6),E.morphNormals&&a.enable(7),E.morphColors&&a.enable(8),E.premultipliedAlpha&&a.enable(9),E.shadowMapEnabled&&a.enable(10),E.doubleSided&&a.enable(11),E.flipSided&&a.enable(12),E.useDepthPacking&&a.enable(13),E.dithering&&a.enable(14),E.transmission&&a.enable(15),E.sheen&&a.enable(16),E.opaque&&a.enable(17),E.pointsUvs&&a.enable(18),E.decodeVideoTexture&&a.enable(19),E.decodeVideoTextureEmissive&&a.enable(20),E.alphaToCoverage&&a.enable(21),v.push(a.mask)}function T(v){const E=d[v.type];let G;if(E){const C=Zt[E];G=Pf.clone(C.uniforms)}else G=v.uniforms;return G}function x(v,E){let G=u.get(E);return G!==void 0?++G.usedTimes:(G=new eg(n,E,v,r),l.push(G),u.set(E,G)),G}function R(v){if(--v.usedTimes===0){const E=l.indexOf(v);l[E]=l[l.length-1],l.pop(),u.delete(v.cacheKey),v.destroy()}}function M(v){o.remove(v)}function A(){o.dispose()}return{getParameters:y,getProgramCacheKey:p,getUniforms:T,acquireProgram:x,releaseProgram:R,releaseShaderCache:M,programs:l,dispose:A}}function sg(){let n=new WeakMap;function e(a){return n.has(a)}function t(a){let o=n.get(a);return o===void 0&&(o={},n.set(a,o)),o}function i(a){n.delete(a)}function r(a,o,c){n.get(a)[o]=c}function s(){n=new WeakMap}return{has:e,get:t,remove:i,update:r,dispose:s}}function ag(n,e){return n.groupOrder!==e.groupOrder?n.groupOrder-e.groupOrder:n.renderOrder!==e.renderOrder?n.renderOrder-e.renderOrder:n.material.id!==e.material.id?n.material.id-e.material.id:n.materialVariant!==e.materialVariant?n.materialVariant-e.materialVariant:n.z!==e.z?n.z-e.z:n.id-e.id}function bl(n,e){return n.groupOrder!==e.groupOrder?n.groupOrder-e.groupOrder:n.renderOrder!==e.renderOrder?n.renderOrder-e.renderOrder:n.z!==e.z?e.z-n.z:n.id-e.id}function El(){const n=[];let e=0;const t=[],i=[],r=[];function s(){e=0,t.length=0,i.length=0,r.length=0}function a(f){let d=0;return f.isInstancedMesh&&(d+=2),f.isSkinnedMesh&&(d+=1),d}function o(f,d,g,y,p,m){let S=n[e];return S===void 0?(S={id:f.id,object:f,geometry:d,material:g,materialVariant:a(f),groupOrder:y,renderOrder:f.renderOrder,z:p,group:m},n[e]=S):(S.id=f.id,S.object=f,S.geometry=d,S.material=g,S.materialVariant=a(f),S.groupOrder=y,S.renderOrder=f.renderOrder,S.z=p,S.group=m),e++,S}function c(f,d,g,y,p,m){const S=o(f,d,g,y,p,m);g.transmission>0?i.push(S):g.transparent===!0?r.push(S):t.push(S)}function l(f,d,g,y,p,m){const S=o(f,d,g,y,p,m);g.transmission>0?i.unshift(S):g.transparent===!0?r.unshift(S):t.unshift(S)}function u(f,d){t.length>1&&t.sort(f||ag),i.length>1&&i.sort(d||bl),r.length>1&&r.sort(d||bl)}function h(){for(let f=e,d=n.length;f<d;f++){const g=n[f];if(g.id===null)break;g.id=null,g.object=null,g.geometry=null,g.material=null,g.group=null}}return{opaque:t,transmissive:i,transparent:r,init:s,push:c,unshift:l,finish:h,sort:u}}function og(){let n=new WeakMap;function e(i,r){const s=n.get(i);let a;return s===void 0?(a=new El,n.set(i,[a])):r>=s.length?(a=new El,s.push(a)):a=s[r],a}function t(){n=new WeakMap}return{get:e,dispose:t}}function lg(){const n={};return{get:function(e){if(n[e.id]!==void 0)return n[e.id];let t;switch(e.type){case"DirectionalLight":t={direction:new k,color:new Ze};break;case"SpotLight":t={position:new k,direction:new k,color:new Ze,distance:0,coneCos:0,penumbraCos:0,decay:0};break;case"PointLight":t={position:new k,color:new Ze,distance:0,decay:0};break;case"HemisphereLight":t={direction:new k,skyColor:new Ze,groundColor:new Ze};break;case"RectAreaLight":t={color:new Ze,position:new k,halfWidth:new k,halfHeight:new k};break}return n[e.id]=t,t}}}function cg(){const n={};return{get:function(e){if(n[e.id]!==void 0)return n[e.id];let t;switch(e.type){case"DirectionalLight":t={shadowIntensity:1,shadowBias:0,shadowNormalBias:0,shadowRadius:1,shadowMapSize:new Ge};break;case"SpotLight":t={shadowIntensity:1,shadowBias:0,shadowNormalBias:0,shadowRadius:1,shadowMapSize:new Ge};break;case"PointLight":t={shadowIntensity:1,shadowBias:0,shadowNormalBias:0,shadowRadius:1,shadowMapSize:new Ge,shadowCameraNear:1,shadowCameraFar:1e3};break}return n[e.id]=t,t}}}let ug=0;function fg(n,e){return(e.castShadow?2:0)-(n.castShadow?2:0)+(e.map?1:0)-(n.map?1:0)}function dg(n){const e=new lg,t=cg(),i={version:0,hash:{directionalLength:-1,pointLength:-1,spotLength:-1,rectAreaLength:-1,hemiLength:-1,numDirectionalShadows:-1,numPointShadows:-1,numSpotShadows:-1,numSpotMaps:-1,numLightProbes:-1},ambient:[0,0,0],probe:[],directional:[],directionalShadow:[],directionalShadowMap:[],directionalShadowMatrix:[],spot:[],spotLightMap:[],spotShadow:[],spotShadowMap:[],spotLightMatrix:[],rectArea:[],rectAreaLTC1:null,rectAreaLTC2:null,point:[],pointShadow:[],pointShadowMap:[],pointShadowMatrix:[],hemi:[],numSpotLightShadowsWithMaps:0,numLightProbes:0};for(let l=0;l<9;l++)i.probe.push(new k);const r=new k,s=new ct,a=new ct;function o(l){let u=0,h=0,f=0;for(let E=0;E<9;E++)i.probe[E].set(0,0,0);let d=0,g=0,y=0,p=0,m=0,S=0,T=0,x=0,R=0,M=0,A=0;l.sort(fg);for(let E=0,G=l.length;E<G;E++){const C=l[E],O=C.color,F=C.intensity,W=C.distance;let z=null;if(C.shadow&&C.shadow.map&&(C.shadow.map.texture.format===Ai?z=C.shadow.map.texture:z=C.shadow.map.depthTexture||C.shadow.map.texture),C.isAmbientLight)u+=O.r*F,h+=O.g*F,f+=O.b*F;else if(C.isLightProbe){for(let V=0;V<9;V++)i.probe[V].addScaledVector(C.sh.coefficients[V],F);A++}else if(C.isDirectionalLight){const V=e.get(C);if(V.color.copy(C.color).multiplyScalar(C.intensity),C.castShadow){const N=C.shadow,Q=t.get(C);Q.shadowIntensity=N.intensity,Q.shadowBias=N.bias,Q.shadowNormalBias=N.normalBias,Q.shadowRadius=N.radius,Q.shadowMapSize=N.mapSize,i.directionalShadow[d]=Q,i.directionalShadowMap[d]=z,i.directionalShadowMatrix[d]=C.shadow.matrix,S++}i.directional[d]=V,d++}else if(C.isSpotLight){const V=e.get(C);V.position.setFromMatrixPosition(C.matrixWorld),V.color.copy(O).multiplyScalar(F),V.distance=W,V.coneCos=Math.cos(C.angle),V.penumbraCos=Math.cos(C.angle*(1-C.penumbra)),V.decay=C.decay,i.spot[y]=V;const N=C.shadow;if(C.map&&(i.spotLightMap[R]=C.map,R++,N.updateMatrices(C),C.castShadow&&M++),i.spotLightMatrix[y]=N.matrix,C.castShadow){const Q=t.get(C);Q.shadowIntensity=N.intensity,Q.shadowBias=N.bias,Q.shadowNormalBias=N.normalBias,Q.shadowRadius=N.radius,Q.shadowMapSize=N.mapSize,i.spotShadow[y]=Q,i.spotShadowMap[y]=z,x++}y++}else if(C.isRectAreaLight){const V=e.get(C);V.color.copy(O).multiplyScalar(F),V.halfWidth.set(C.width*.5,0,0),V.halfHeight.set(0,C.height*.5,0),i.rectArea[p]=V,p++}else if(C.isPointLight){const V=e.get(C);if(V.color.copy(C.color).multiplyScalar(C.intensity),V.distance=C.distance,V.decay=C.decay,C.castShadow){const N=C.shadow,Q=t.get(C);Q.shadowIntensity=N.intensity,Q.shadowBias=N.bias,Q.shadowNormalBias=N.normalBias,Q.shadowRadius=N.radius,Q.shadowMapSize=N.mapSize,Q.shadowCameraNear=N.camera.near,Q.shadowCameraFar=N.camera.far,i.pointShadow[g]=Q,i.pointShadowMap[g]=z,i.pointShadowMatrix[g]=C.shadow.matrix,T++}i.point[g]=V,g++}else if(C.isHemisphereLight){const V=e.get(C);V.skyColor.copy(C.color).multiplyScalar(F),V.groundColor.copy(C.groundColor).multiplyScalar(F),i.hemi[m]=V,m++}}p>0&&(n.has("OES_texture_float_linear")===!0?(i.rectAreaLTC1=ae.LTC_FLOAT_1,i.rectAreaLTC2=ae.LTC_FLOAT_2):(i.rectAreaLTC1=ae.LTC_HALF_1,i.rectAreaLTC2=ae.LTC_HALF_2)),i.ambient[0]=u,i.ambient[1]=h,i.ambient[2]=f;const v=i.hash;(v.directionalLength!==d||v.pointLength!==g||v.spotLength!==y||v.rectAreaLength!==p||v.hemiLength!==m||v.numDirectionalShadows!==S||v.numPointShadows!==T||v.numSpotShadows!==x||v.numSpotMaps!==R||v.numLightProbes!==A)&&(i.directional.length=d,i.spot.length=y,i.rectArea.length=p,i.point.length=g,i.hemi.length=m,i.directionalShadow.length=S,i.directionalShadowMap.length=S,i.pointShadow.length=T,i.pointShadowMap.length=T,i.spotShadow.length=x,i.spotShadowMap.length=x,i.directionalShadowMatrix.length=S,i.pointShadowMatrix.length=T,i.spotLightMatrix.length=x+R-M,i.spotLightMap.length=R,i.numSpotLightShadowsWithMaps=M,i.numLightProbes=A,v.directionalLength=d,v.pointLength=g,v.spotLength=y,v.rectAreaLength=p,v.hemiLength=m,v.numDirectionalShadows=S,v.numPointShadows=T,v.numSpotShadows=x,v.numSpotMaps=R,v.numLightProbes=A,i.version=ug++)}function c(l,u){let h=0,f=0,d=0,g=0,y=0;const p=u.matrixWorldInverse;for(let m=0,S=l.length;m<S;m++){const T=l[m];if(T.isDirectionalLight){const x=i.directional[h];x.direction.setFromMatrixPosition(T.matrixWorld),r.setFromMatrixPosition(T.target.matrixWorld),x.direction.sub(r),x.direction.transformDirection(p),h++}else if(T.isSpotLight){const x=i.spot[d];x.position.setFromMatrixPosition(T.matrixWorld),x.position.applyMatrix4(p),x.direction.setFromMatrixPosition(T.matrixWorld),r.setFromMatrixPosition(T.target.matrixWorld),x.direction.sub(r),x.direction.transformDirection(p),d++}else if(T.isRectAreaLight){const x=i.rectArea[g];x.position.setFromMatrixPosition(T.matrixWorld),x.position.applyMatrix4(p),a.identity(),s.copy(T.matrixWorld),s.premultiply(p),a.extractRotation(s),x.halfWidth.set(T.width*.5,0,0),x.halfHeight.set(0,T.height*.5,0),x.halfWidth.applyMatrix4(a),x.halfHeight.applyMatrix4(a),g++}else if(T.isPointLight){const x=i.point[f];x.position.setFromMatrixPosition(T.matrixWorld),x.position.applyMatrix4(p),f++}else if(T.isHemisphereLight){const x=i.hemi[y];x.direction.setFromMatrixPosition(T.matrixWorld),x.direction.transformDirection(p),y++}}}return{setup:o,setupView:c,state:i}}function Tl(n){const e=new dg(n),t=[],i=[];function r(u){l.camera=u,t.length=0,i.length=0}function s(u){t.push(u)}function a(u){i.push(u)}function o(){e.setup(t)}function c(u){e.setupView(t,u)}const l={lightsArray:t,shadowsArray:i,camera:null,lights:e,transmissionRenderTarget:{}};return{init:r,state:l,setupLights:o,setupLightsView:c,pushLight:s,pushShadow:a}}function hg(n){let e=new WeakMap;function t(r,s=0){const a=e.get(r);let o;return a===void 0?(o=new Tl(n),e.set(r,[o])):s>=a.length?(o=new Tl(n),a.push(o)):o=a[s],o}function i(){e=new WeakMap}return{get:t,dispose:i}}const pg=`void main() {
	gl_Position = vec4( position, 1.0 );
...
Risk: `+M.riskLevel:""}`);const R=30;S.on("tick",()=>{T.attr("x1",M=>M.source.x).attr("y1",M=>M.source.y).attr("x2",M=>M.target.x).attr("y2",M=>M.target.y),x.attr("transform",M=>(M.x=Math.max(R,Math.min(s-R,M.x)),M.y=Math.max(R,Math.min(a-R,M.y)),`translate(${M.x},${M.y})`))}),S.alpha(1).restart()}function Vv(n,e){const t=e.filter(p=>p.role==="sybil");if(t.length===0)return;const i=n.clientWidth||600,r=200,s={top:10,right:10,bottom:30,left:40},a=document.createElement("canvas");a.width=i*2,a.height=r*2,a.style.width=i+"px",a.style.height=r+"px",n.appendChild(a);const o=a.getContext("2d");o.scale(2,2);const c=i-s.left-s.right,l=r-s.top-s.bottom,u=t.length,h=Math.min(c/u-2,24),f=(c-h*u)/(u+1),d=1.5;for(let p=0;p<u;p++){const S=(p===0?1.37:.83-p*.003)/d*l,T=s.left+f+p*(h+f),x=s.top+l-S;o.fillStyle=p===0?"#ffa657":"#ff3b3b",o.globalAlpha=.85,o.beginPath(),o.roundRect(T,x,h,S,[2,2,0,0]),o.fill(),o.globalAlpha=1,u<=25&&(o.fillStyle="#4a4a5a",o.font="7px JetBrains Mono",o.textAlign="center",o.fillText(`#${p+1}`,T+h/2,r-8))}const g=.83,y=s.top+l-g/d*l;o.strokeStyle="#ffa657",o.lineWidth=1,o.setLineDash([4,4]),o.beginPath(),o.moveTo(s.left,y),o.lineTo(i-s.right,y),o.stroke(),o.setLineDash([]),o.fillStyle="#ffa657",o.font="9px JetBrains Mono",o.textAlign="right",o.fillText(`avg: ${g}%`,i-s.right-4,y-4),o.fillStyle="#4a4a5a",o.font="8px JetBrains Mono",o.textAlign="right";for(let p=0;p<=d;p+=.5){const m=s.top+l-p/d*l;o.fillText(`${p.toFixed(1)}%`,s.left-4,m+3)}o.fillStyle="#ff3b3b",o.font="bold 9px Orbitron",o.textAlign="left",o.letterSpacing="1px"}function Hv(n,e){const{token:t,findings:i,walletLinks:r,bundleData:s,creatorData:a,pools:o}=e,c=[];t.createdAt&&c.push({time:t.createdAt,title:"Token Created",desc:`${t.name} deployed on Pump.fun bonding curve`,type:"critical",icon:"●"}),a&&a.tx_types&&a.tx_types.CREATE_VESTING_ESCROW&&c.push({time:t.createdAt,title:"Vesting Escrow Created",desc:"Fake legitimacy signal — makes scanners think tokens are locked",type:"warning",icon:"◆"});for(const h of o)h.pool_created_at&&c.push({time:h.pool_created_at,title:`${h.dex.toUpperCase()} Pool Created`,desc:`Price: $${h.price<.001?h.price.toFixed(6):h.price.toFixed(4)} | Liquidity: $${h.liquidity>1e3?(h.liquidity/1e3).toFixed(0)+"K":h.liquidity.toFixed(2)}`,type:h.dex==="pumpswap"?"info":h.liquidity<100?"warning":"info",icon:"◇",link:h.address?`https://solscan.io/account/${h.address}`:null});const l=r.filter(h=>h.role==="sybil");l.length>0&&c.push({time:null,title:`${l.length} Sybil Wallets Load Up`,desc:`Each wallet buys ~0.83% of supply. Combined: ${(l.length*.83).toFixed(1)}% controlled by one entity. All wallets created today.`,type:"critical",icon:"▲"}),s&&s.bundle_slots>0&&c.push({time:null,title:"Bundled Transactions Detected",desc:`${s.bundle_slots} block slots with multi-transaction bundles — coordinated bot activity`,type:"critical",icon:"⚡"}),s&&s.early_buyers>0&&c.push({time:null,title:`${s.early_buyers} Rapid Early Buys`,desc:"Burst of buying in the first minutes — volume inflation bots",type:"warning",icon:"↑"}),a&&a.sol_flows&&(a.sol_flows.in-a.sol_flows.out,c.push({time:null,title:"Creator Wallet Activity",desc:`Received ${a.sol_flows.in.toFixed(4)} SOL, sent out ${a.sol_flows.out.toFixed(4)} SOL. Balance: ${(a.balance||0).toFixed(4)} SOL. Total transactions: ${a.tx_count||0}`,type:"info",icon:"◎"}));const u={critical:{dot:"#ff3b3b",bg:"rgba(255,59,59,0.06)",border:"rgba(255,59,59,0.2)",glow:"rgba(255,59,59,0.4)"},warning:{dot:"#ffa657",bg:"rgba(255,166,87,0.06)",border:"rgba(255,166,87,0.2)",glow:"rgba(255,166,87,0.3)"},info:{dot:"#58a6ff",bg:"rgba(88,166,255,0.06)",border:"rgba(88,166,255,0.2)",glow:"rgba(88,166,255,0.3)"}};n.innerHTML=`
  ...
  `,e}function Xv(n,e){if(e.length===0){n.innerHTML='<div style="text-align:center;padding:24px;color:var(--chrome-dark);font-size:11px;">No recent activity from watched wallets</div>';return}n.innerHTML="";for(const t of e)n.appendChild(fu(t))}function Jl(n,e=8){return n?`${n.slice(0,e)}...${n.slice(-6)}`:"unknown"}function $v(n){return(n||"").toLowerCase()}function qv(n){return n>=70?"var(--critical)":n>=40?"var(--high)":n>=20?"var(--medium)":"var(--clean)"}function Yv(n){return n>=70?"EXTREME RISK":n>=40?"HIGH RISK":n>=20?"MODERATE":"LOW RISK"}async function eo(n,e){try{const t=await nn.getAudit(e);n.innerHTML=Kv(t,e),Zv(n,t,e);const i=n.querySelector("#wallet-graph-container");i&&(t.walletLinks.length>0||t.connections.length>0)&&uu(i,{walletLinks:t.walletLinks,connections:t.connections,creator:t.token.creator});const r=n.querySelector("#holder-chart-container");r&&Vv(r,t.walletLinks);const s=n.querySelector("#timeline-container");s&&Hv(s,t);const a=n.querySelector("#live-feed-container");if(a){const c=t.walletLinks.filter(l=>l.role==="sybil"||l.role==="creator"||l.role==="funder").map(l=>l.wallet_address);Wv(a,c,t.walletLinks)}}catch{n.innerHTML=`
      <div style="max-width:800px;margin:0 auto;padding:60px 40px;text-align:center;">
        ...
        <p style="font-family:'JetBrains Mono',monospace;font-size:11px;color:var(--chrome-dark);margin-bottom:32px;word-break:break-all;">${e}</p>
    ...
    `;const i=n.querySelector("#run-audit-btn"),r=n.querySelector("#audit-trigger"),s=n.querySelector("#audit-progress"),a=n.querySelector("#audit-status-text"),o=n.querySelector("#audit-dots");i&&i.addEventListener("click",async()=>{r.style.display="none",s.style.display="";try{const c=await nn.triggerAudit(e);if(c.status==="cached"||c.status==="complete"){eo(n,e);return}let l=0;const u=40,h=["Fetching token data from DexScreener...","Running RugCheck report...","Resolving top holders on-chain...","Tracing funding sources...","Analyzing creator wallet history...","Detecting bundled transactions...","Scanning LP manipulation events...","Building wallet cluster graph...","Calculating risk score...","Generating final report..."],f=setInterval(async()=>{l++;const d=h[Math.min(l-1,h.length-1)];o&&(o.textContent=d);try{const g=await nn.getAudit(e);g.token&&g.token.status==="complete"&&(clearInterval(f),a.textContent="AUDIT COMPLETE",a.style.color="var(--clean)",setTimeout(()=>eo(n,e),500))}catch{}l>=u&&(clearInterval(f),a.textContent="AUDIT TIMED OUT",a.style.color="var(--critical)",o&&(o.textContent="Try refreshing the page in a minute."))},5e3)}catch(c){a.textContent="AUDIT FAILED",a.style.color="var(--critical)",o&&(o.textContent=c.message)}})}}function Kv(n,e){const{token:t,findings:i,pools:r,walletLinks:s,connections:a,links:o,bundleData:c,creatorData:l}=n,u=t.riskScore,h=qv(u),f=s.filter(d=>d.role==="sybil");return s.filter(d=>d.role==="funder"),s.find(d=>d.role==="creator"),`
      ...
      <div style="display:grid;grid-template-columns:1fr 1fr;gap:20px;">
        ...
        <div class="glass-panel" style="padding:24px;">
          ...
          <div style="display:flex;flex-direction:column;gap:10px;">
            ${r.map(d=>{const g=Math.max(...r.map(T=>T.liquidity||1)),y=g>0?d.liquidity/g*100:0,p=d.dex==="pumpswap"?"var(--clean)":d.dex==="pumpfun"?"var(--low)":"var(--accent)",m=d.dex==="pumpswap"?"rgba(0,210,106,0.06)":d.dex==="pumpfun"?"rgba(88,166,255,0.06)":"rgba(188,140,255,0.06)",S=d.dex==="pumpswap"?"rgba(0,210,106,0.15)":d.dex==="pumpfun"?"rgba(88,166,255,0.15)":"rgba(188,140,255,0.15)";return`
              <div style="background:${m};border:1px solid ${S};border-radius:8px;padding:14px 16px;">
                ...
                <div style="margin-top:8px;">
                  <div style="height:4px;background:rgba(255,255,255,0.04);border-radius:2px;overflow:hidden;">
                    <div style="height:100%;width:${Math.max(y,.5)}%;background:${p};border-radius:2px;transition:width 0.5s;"></div>
                  </div>
                </div>
              </div>
              `}).join("")}
